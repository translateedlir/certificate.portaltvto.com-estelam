...
Calendar._TT["ABOUT"] =
"انتخاب تاریخ:\n" +
"- دکمه های \xab, \xbb برای انتخاب سال\n" +
"- دکمه های " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " برای انتخاب ماه\n" +
"- برای انتخاب سریع کلیک موس را روی دکمه ها نگه دارید.";
